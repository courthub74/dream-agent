...
window.allWorks = [
    ...
    { 
      ...
      related:["temple_of_openings", "polar_bear"],
    ...
    { 
      ...
      featured: true,
      dateCreated: "2022-10-06",
      related:["internet_of_the_old_world", "the_tech_era", "internet_of_the_new_world"],
      motifs: ["orbs", "glowing"],
    ...
    { 
      ...
      related:["the_refactoring_ritual", "bottling_the_republic"],
    ...
    { 
      ...
      related:["the_fear_room", "daniels_vision_from_another_angle", "discovery_of_the_indigenous"],
      motifs:["map","bottles"],
